        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
            ...
            <div className="container relative z-10 flex flex-col items-center text-center px-4">
                ...
                <motion.div
                    ...
                    className="mb-8"
                >
                    <img src="/logo.png" alt="Blindly Logo" className="h-16 md:h-20 w-auto opacity-90 drop-shadow-[0_0_15px_rgba(124,58,237,0.5)]" />
                </motion.div>
                ...
                >
                    ...
                    <span className="tracking-wide text-brand-purple-glow">The Future of True Connection</span>
                </motion.div>
                ...
                >
                    Blindly helps you create real connections through personality, hobbies, and conversation before revealing the photo.
                </motion.p>
                ...
                >
                    <button className="relative group px-9 py-4 bg-white text-bg-primary font-bold rounded-full text-lg overflow-hidden transition-all hover:shadow-[0_0_50px_rgba(255,255,255,0.4)] hover:scale-105 active:scale-95">
                    ...
                    >
                        ...
                        <div className="relative h-64 bg-bg-surface overflow-hidden">
                            ...
                            <div className="absolute inset-0 backdrop-blur-[24px] bg-bg-elevated/30 flex flex-col items-center justify-center z-10">
                                ...
                                <span className="text-white font-bold text-lg">Photo Hidden</span>
                                <span className="text-text-muted text-sm mt-1">Match & chat to unlock</span>
                            </div>
                            ...
                            <div className="absolute bottom-4 left-4 z-20 bg-black/40 backdrop-blur-md px-3 py-1.5 rounded-full border border-white/10 flex items-center gap-1.5">
                                ...
                                <span className="text-xs font-medium text-white">96% Match</span>
                            </div>
                        </div>
                        ...
                        <div className="p-5">
                            ...
                            <div className="bg-bg-elevated border border-accent-ai/20 rounded-xl p-3 mb-4">
                                <div className="flex items-center gap-2 mb-1.5">
                                    ...
                                    <span className="text-xs font-bold text-accent-ai uppercase tracking-wider">AI Summary</span>
                                </div>
                                <p className="text-xs text-text-secondary leading-relaxed">
                                    Sarah is a creative soul who loves jazz clubs and photography. A genuine match if you appreciate deep talks!
                                </p>
                            </div>

                            {/* Tags */}
                            <div className="flex flex-wrap gap-2 mt-2">
                                <span className="px-3 py-1.5 rounded-full bg-white/5 border border-white/5 text-xs text-text-primary">Photography</span>
                                <span className="px-3 py-1.5 rounded-full bg-white/5 border border-white/5 text-xs text-text-primary">Jazz</span>
                                <span className="px-3 py-1.5 rounded-full bg-white/5 border border-white/5 text-xs text-text-primary">Art</span>
                                <span className="px-3 py-1.5 rounded-full bg-white/5 border border-white/5 text-xs text-text-primary">+3</span>
                            </div>
                        </div>
                    </motion.div>
