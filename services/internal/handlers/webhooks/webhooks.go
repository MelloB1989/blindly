...
var dodoProductToPlan = map[string]string{
	"blindly_plus_monthly":  subscriptions.PlanPlus,
	"blindly_plus_yearly":   subscriptions.PlanPlus,
	"blindly_pro_monthly":   subscriptions.PlanPro,
	"blindly_pro_yearly":    subscriptions.PlanPro,
	"blindly_elite_monthly": subscriptions.PlanElite,
	"blindly_elite_yearly":  subscriptions.PlanElite,
}

// RevenueCat product ID to plan ID mapping
var revcatProductToPlan = map[string]string{
	"blindly_plus_monthly":  subscriptions.PlanPlus,
	"blindly_plus_annual":   subscriptions.PlanPlus,
	"blindly_pro_monthly":   subscriptions.PlanPro,
	"blindly_pro_annual":    subscriptions.PlanPro,
	"blindly_elite_monthly": subscriptions.PlanElite,
	"blindly_elite_annual":  subscriptions.PlanElite,
}
