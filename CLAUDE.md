# CLAUDE.md - Blindly Codebase Documentation

## Project Overview

**Blindly** is a personality-first dating app where users connect based on personality before photos are revealed. The codebase is a monorepo with three main workspaces:
...
go build -o blindly .    # Build binary
go test ./...            # Run tests
```
...
```go
import "blindly/internal/mailer"
