...
import { graphqlAuthService, UpdateUserInput } from "../../services/graphql-auth";
            ...
            <SafeAreaView className="flex-1" edges={['top']}>
                ...
                >
                    ...
                    <View className="flex-row justify-between items-center px-6 py-4 border-b border-white/5">
                        ...
                        <Typography variant="h3" className="text-white">Edit Profile</Typography>
                        <Button
                            variant="ghost"
                            size="sm"
                            onPress={handleSave}
                        ...
                        <View className="py-6">
                            ...
                            <View className="px-6 mb-6">
                                <View className="flex-row justify-between items-center mb-2">
                                    <Typography variant="label" className="text-white/60">Bio</Typography>
                                    {isGeneratingBio && <ActivityIndicator size="small" color="#7C3AED" />}
                                </View>
                                ...
                                <Button
                                    ...
                                    className="self-end"
                                >
                                    <Typography variant="caption" className="text-[#A78BFA] font-bold">
                            ...
                            <MetadataEditor
                                extra={extra}
                                onChange={(key, value) => setExtra(prev => ({ ...prev, [key]: value }))}
                            />
