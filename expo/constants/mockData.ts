...
export const MOCK_POSTS = [
  {
    ...
    content:
      "Just finished building my new mechanical keyboard! The thock is real. ⌨️🔊 Anyone else into custom builds?",
    timestamp: "2h ago",
    likes: 24,
    comments: 5,
    reposts: 2,
  ...
  },
  {
    ...
    user: {
      id: "u3",
      name: "Taylor",
      avatar: null, // Hidden/Locked
      isRevealed: false,
    },
    content:
      "Hiking up Mount Tamalpais this weekend. The forecast looks perfect! ☀️🏔️ Anyone want to join?",
    timestamp: "4h ago",
    likes: 12,
    comments: 8,
    reposts: 0,
  ...
  },
  {
    ...
    content:
      "Finally nailed my homemade pasta recipe! 🍝 The secret is letting the dough rest for at least 30 minutes. Who wants the full recipe?",
    timestamp: "8h ago",
    likes: 67,
    comments: 23,
    reposts: 12,
  ...
  },
  {
    ...
    content:
      "Just finished reading 'Tomorrow, and Tomorrow, and Tomorrow' and I'm emotionally destroyed in the best way. 📚😭 Any book recommendations to fill this void?",
    timestamp: "12h ago",
    likes: 89,
    comments: 41,
    reposts: 8,
  ...
  },
  {
    ...
    content:
      "Max (my golden retriever) learned a new trick today! He can now close the fridge after getting his treats. I've created a monster. 🐕😂",
    timestamp: "1d ago",
    likes: 156,
    comments: 28,
    reposts: 15,
  ...
  },
  {
    ...
    content:
      "Spent the whole weekend at SFMOMA. The new exhibition is incredible! Art has a way of making you see the world differently. 🎨✨",
    timestamp: "1d ago",
    likes: 34,
    comments: 9,
    reposts: 3,
