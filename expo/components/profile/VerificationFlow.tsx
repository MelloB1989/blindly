                    ...
                    {step === 'intro' && (
                        <View style={styles.centerContent}>
                            ...
                            <Typography variant="body" className="text-white/60 text-center leading-6 mb-8 px-4">
                                ...
                                <Typography className="text-[#A78BFA] font-bold">"Blindly"</Typography>
                        ...
                        <View style={{ flex: 1 }}>
                            ...
                            <View style={styles.instructionBox}>
                                <Typography variant="body" className="text-white/80 text-center">
                                    Make sure <Typography className="text-[#A78BFA] font-bold">"Blindly"</Typography> is clearly visible
                                </Typography>
                            </View>
